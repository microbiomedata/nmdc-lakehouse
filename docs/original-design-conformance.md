...
| Automated TSV or Parquet dump | One command streams schema-defined collections to local Parquet. | Implemented for manual runs; atomic snapshots remain [#133](https://github.com/microbiomedata/nmdc-lakehouse/issues/133) |
| Lakehouse-ready managed tables | Parquet is the interchange layer; Iceberg and BERDL publication are external or incomplete. | Partial; sink and publication work remain [#10](https://github.com/microbiomedata/nmdc-lakehouse/issues/10), [#50](https://github.com/microbiomedata/nmdc-lakehouse/issues/50), and [#51](https://github.com/microbiomedata/nmdc-lakehouse/issues/51) |
| Provenance and refresh visibility | Human-readable logs and manual run policy exist. | Partial; structured measurements are [#189](https://github.com/microbiomedata/nmdc-lakehouse/issues/189), reproducible manifests are [#135](https://github.com/microbiomedata/nmdc-lakehouse/issues/135), and update semantics are [#147](https://github.com/microbiomedata/nmdc-lakehouse/issues/147) |
