...
| Lakehouse-ready managed tables | Parquet is the interchange layer; Iceberg and BERDL publication are external or incomplete. | Partial; sink and publication work remain in [#51](https://github.com/microbiomedata/nmdc-lakehouse/issues/51). [#10](https://github.com/microbiomedata/nmdc-lakehouse/issues/10) and [#50](https://github.com/microbiomedata/nmdc-lakehouse/issues/50) are both closed |
