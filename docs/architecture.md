...
package's [transformation support reference](https://github.com/microbiomedata/nmdc-lakehouse-schema/blob/codex/versioned-source-artifacts/src/docs/transformation-support.md)
