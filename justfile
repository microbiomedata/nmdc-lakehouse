...
# Select the configured source pair and prepare full validation and metadata together.
...
# only; none of them converts or uploads data. FEATURE_DIR defaults to the gitignored local/feature-tables.
